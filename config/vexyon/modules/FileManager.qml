...
FloatingWindow {
    ...
    // Vista list/grid persistida en shell.json (fileManager.gridMode) vía el
    // Config existente; valor ausente o corrupto cae a lista. Binding vivo.
    property bool gridMode: Config.get("fileManager", "gridMode", false) === true
            ...
            Rectangle {
                ...
                RowLayout {
                    ...
                    IconButton {
                        ...
                        // Config.set repinta gridMode a través del binding y
                        // deja la elección guardada para el próximo arranque
                        onClicked: Config.set("fileManager", "gridMode", !fm.gridMode)
                    }
                }
            }
